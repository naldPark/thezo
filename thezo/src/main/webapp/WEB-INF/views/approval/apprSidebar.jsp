...
<nav class="w3-sidebar" style="width:160px;"><br>
  <div class="w3-bar-block">
    <a href="main.appr" class="w3-bar-item w3-button w3-padding"><i class="fas fa-folder"></i> &nbsp; 결제 HOME</a>
    ...
    <div id="sendDocu" class="w3-bar-block w3-hide w3-show">
      <a href="reportDocu.appr" class="w3-bar-item w3-button ml-2"><i class="far fa-folder-open"></i> &nbsp;&nbsp;상신문서</a>
      <a href="reportFinDocu.appr" class="w3-bar-item w3-button ml-2"><i class="far fa-folder-open"></i> &nbsp;&nbsp;완료문서</a>
      <a href="tempDocu.appr" class="w3-bar-item w3-button ml-2"><i class="far fa-folder-open"></i> &nbsp;&nbsp;임시저장</a>
    </div>
    ...
    <div id="receiveDocu" class="w3-bar-block w3-hide w3-show">
      <a href="waiting.appr" class="w3-bar-item w3-button ml-2"><i class="far fa-folder-open"> </i> &nbsp;&nbsp;결재대기</a>
      <a href="approved.appr" class="w3-bar-item w3-button ml-2"><i class="far fa-folder-open"> </i> &nbsp;&nbsp;결재내역</a>
      <a href="reference.appr" class="w3-bar-item w3-button ml-2"><i class="far fa-folder-open"> </i> &nbsp;&nbsp;수신참조</a>
    </div>
