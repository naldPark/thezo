...
<style>
    ...
    .outer>h2, .search-by-name, .search-by-category{
        margin-left: 10px;
    } 
    ...
    .search-by-name>div>input{
        width: 172px;
        height: 28px;
        outline: none;
        border: none;
    }
    .search-by-name>div>button{
        width: 28px;
        height: 28px;
    ...
    .search-by-name>div>button:hover{
        color: orange;
    }

    .search-by-category>p, .department-list, .department-list{
        font-size: 17px;
        font-weight: bold;
        margin-left: 10px;
        margin-bottom: 10px;
    ...
    .department-list>span, .department-list>span{
        margin-right: 25px;
    }
    .department-list>select, .department-list>select{
        font-weight: normal;
        border-radius: 4px;
        width: 255px;
        height: 28px;
    ...
    #search-result-area>table>thead>tr{
        background-color: rgb(234,234,234);
    }

    #search-result-area>table>thead>tr>th{
        width: 20%;
    }


    #search-result-area>table>tbody>tr{
        height: 28px;
    }
    
    #search-result-area>table>tbody>tr>td{
        font-size: 14px;    
        vertical-align: middle;
    }

    #search-result-area>table>tbody>tr button{
        height: 25px;
        font-size: 12px;    
        border: none;
        border-radius: 3px;
