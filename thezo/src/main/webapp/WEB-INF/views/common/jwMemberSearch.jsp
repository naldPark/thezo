...
<style>
	...
	#msg-mem-name::placeholder{color:red;}
...
<body>	
    ...
    <div class="search-by-name">
        <span>▶ 이름으로 검색</span>
        <div>
            <input type="text" id="msg-mem-name" onKeypress="javascript:if(event.keyCode==13){selectMemInfoBySearch();}">
