...
<link href="resources/summernote-0.8.18-dist/summernote-lite.min.css"
	rel="stylesheet">
	...
	<div class="outer">
		...
		<div class="innerOuter">
			...
			<div id="thumbnail" align="center">
				...
				<img id="contentImg1" width="150" height="120"> <img
					id="contentImg2" width="150" height="120"> <img
					id="contentImg3" width="150" height="120">
			</div>
			<br>
			...
			<form id="enrollForm" method="post" action="" enctype="">
				<table align="center">
					...
					<tr>
						...
						<td><input type="text" id="title" class="form-control"
							name="" required placeholder="금액 입력"></td>
					</tr>
					<tr>
						<!--에디터 api 적용하자-->
						...
						<td>
							<div id="file-area">
								<input type="file" id="upfile" class="form-control-file border"
									name="file1" onchange="loadImg(this, 1);" required> <input
									type="file" id="upfile" class="form-control-file border"
									name="file2" onchange="loadImg(this, 2);"> <input
									type="file" id="upfile" class="form-control-file border"
									name="file3" onchange="loadImg(this, 3);"> <input
									type="file" id="upfile" class="form-control-file border"
