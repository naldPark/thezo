...
<body>
    ...
    <div class="innerOuter">
        ...
        <form id="marketEnroll" method="post" action="marketInsert.bo" enctype="multipart/form-data">
			...
			<input type="hidden" name="marketWriter" value="${ loginUser.memId }">
	        
        
            <table id="marketUpdate" align="center">
                <tr>
                    <th><label for="title">품명</label></th>
                    <td><input type="text" id="marketTitle" class="form-control" name="marketTitle" required><br></td>
                </tr>
                <tr>
                    <th><label for="price">가격</label></th>
                    <td><input type="number" id="price" class="form-control" name="price" required><br></td>
                </tr>
                <tr><!--에디터 api 적용하자-->
                    <th><label for="content">내용</label></th>
                     <th><textarea class="form-control" name="marketContent" id="summernote"></textarea></th>
                </tr>
            </table>
            <br><br>
